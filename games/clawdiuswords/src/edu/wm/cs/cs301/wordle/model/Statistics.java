/**
 * The purpose of the Statistics class is to 
 * set up the path of the user's statistics file for each mode.
 * It also provides methods to write in the updated statistics from the users
 * most recent game, and retrieve various information about the user's
 * performance such as their current streak, and their total number of games.
 * 
 * @author Lekha Reddy
 */
...
public class Statistics {
	...
	public Statistics(int columns) {
		this.wordsGuessed = new ArrayList<>();
		String fileSeparator = System.getProperty("file.separator");
		this.path = System.getProperty("user.home") + fileSeparator + "Wordle" + fileSeparator + Integer.toString(columns);
