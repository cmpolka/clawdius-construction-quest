/**
 * The purpose of the ReadWordsRunnable class is to 
 * create a list of words and randomly select a word from it 
 * to use as the winning word for the current model.
 * 
 * @author Lekha Reddy
 */
