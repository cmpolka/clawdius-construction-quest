/**
 * The purpose of the InstructionsDialog class is to 
 * create a dialog that will display the instructions 
 * of the Wordle game when the user selects the 
 * 'Instructions...' button in the menu bar.
 * 
 * @author Lekha Reddy
 */
